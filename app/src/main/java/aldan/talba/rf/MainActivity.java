...
public class MainActivity extends AppCompatActivity {
	...
	private boolean isFromIntentBack = false;
	...
	private void initialize() {
		...
		_drawer = findViewById(R.id._drawer);ActionBarDrawerToggle _toggle = new ActionBarDrawerToggle(MainActivity.this, _drawer, _toolbar, R.string.app_name, R.string.app_name);
		...
		Button _drawer_button4 = _nav_view.findViewById(R.id.button4);
		Button _drawer_button3 = _nav_view.findViewById(R.id.button3);
		Switch _drawer_switch1 = _nav_view.findViewById(R.id.switch1);
		Button _drawer_button1 = _nav_view.findViewById(R.id.button1);
		Button _drawer_button6 = _nav_view.findViewById(R.id.button6);
		Button _drawer_button7 = _nav_view.findViewById(R.id.button7);
		Button _drawer_button5 = _nav_view.findViewById(R.id.button5);
		...
		webview2.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
				...
				view.loadUrl("file:///android_asset/www/error/index.html");

			работает не адекватно. вся PWA-шка теряет смысл т.к. кеш не учитывается. придется отложить до лучших времен
			}*/
		...
		_drawer_button4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				SketchwareUtil.showMessage(getApplicationContext(), "Обновление");
				t = new TimerTask() {
					@Override
					public void run() {
		...
		_drawer_button3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				SketchwareUtil.showMessage(getApplicationContext(), "Кеш очищен");
				t = new TimerTask() {
					@Override
					public void run() {
						runOnUiThread(new Runnable() {
		...
		_drawer_button7.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent1.setClass(getApplicationContext(), UlusyActivity.class);
		...
		_drawer_button1.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View _view) {
				intent1.setClass(getApplicationContext(), OboutActivity.class);
				startActivity(intent1);
				t = new TimerTask() {
					@Override
					public void run() {
		...
		_drawer_button6.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				Intent shareIntent = new Intent(Intent.ACTION_SEND); shareIntent.setType("text/plain"); shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Приложение Талба: все объявления Якутии"); shareIntent.putExtra(Intent.EXTRA_TEXT, "Скачать приложение Талба с Play Market можно по ссылке https://play.google.com/store/apps/developer?id=Талба"); startActivity(Intent.createChooser(shareIntent, "Приложение талба: все объявления Якутии"));
			}
		});
		...
		_drawer_button5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "Приложение закрывается");
				...
				_timer.schedule(t, 800);
			}
		});
	}
	@SuppressLint({"SetJavaScriptEnabled", "ObsoleteSdkInt"})
	private void initializeLogic() {
		setTitle("ТАЛБА Алдан beta");
		_Fab_Color();
		...
		if (intent.getData() == null){
			...
			Log.d("asdasddat", intent.getDataString());
			webview2.loadUrl(intent.getData().toString());
		}
	...
	public void onBackPressed() {
		if (_drawer.isDrawerOpen(GravityCompat.START)) {
			...
			else if (intent.getData() != null && !isFromIntentBack){
				webview2.loadUrl("file:///android_asset/www/index.html");
				webview2.clearHistory();
				isFromIntentBack = true;
			}
					...
					.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
						...
						public boolean onMenuItemClick(MenuItem menuItem) {
							...
							if(URLUtil.isValidUrl(DownloadImageURL)){
								...
								Toast.makeText(MainActivity.this,"Изображение сохранено в папке загрузок",Toast.LENGTH_LONG).show();
							}
							else {
